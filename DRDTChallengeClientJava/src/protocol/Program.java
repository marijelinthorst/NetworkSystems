...
public class Program {
    ...
    private static String groupToken = "675a3e5e-f2a1-43fb-8b9b-c038d7d9a2ca";
    ...
    private static String serverAddress = "networkingchallenges.ewi.utwente.nl";//"drdt.ns-staging.nl";
